 ...
 * @author arsi
 */
@ActionID(id = "sk.apli.nb.windowactions.CloseAtRight", category = "Windows/TabOperations")
@ActionRegistration(displayName = "Close tabs to the right", lazy = false)
@ActionReference(path = "Windows/TabOperations",position = 100)
public class CloseAtRight extends AbstractAction
    ...
    public CloseAtRight() {
        ...
        putValue(NAME, "Close tabs to the right"); //NOI18N
    ...
    public CloseAtRight(TopComponent topComp, boolean isContext) {
        tc = topComp;
        this.isContext = isContext;
        //Include the name in the label for the popup menu - it may be clicked over
        //a component that is not selected
        putValue(Action.NAME, "Close tabs to the right"); //NOI18N
